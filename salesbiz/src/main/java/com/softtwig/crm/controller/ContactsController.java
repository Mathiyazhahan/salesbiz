...
@Controller
public class ContactsController extends ControllerUtils implements Serializable{

	private static final long serialVersionUID = -7566828223244087438L;

	private static final SalesBizLogger LOGGER = SalesBizLogger.getLogger(ContactsController.class);
