...
public class LeadHistoryDO implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 8747184592385472218L;
	private int leadId;
	private int leadHistoryId;
	private String name;
	 ...
	 * @return the leadId
	 */
	@Column(name = "LEAD_ID", unique = false, nullable = false)
	...
	/**
	 * @return the leadHistoryId
	 */

	@Id
	@GeneratedValue
	@Column(name = "LEAD_HISTORY_ID", unique = true, nullable = false)
	public int getLeadHistoryId() {
		return leadHistoryId;
	}

	/**
	 * @param leadHistoryId
	 *            the leadHistoryId to set
	 */
	public void setLeadHistoryId(int leadHistoryId) {
