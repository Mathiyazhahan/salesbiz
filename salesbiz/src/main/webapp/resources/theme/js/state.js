/*$(document).ready(function() {
    ...
    var updateState =document.state.value; 
    //	document.getElementById("updateState");
alert("The State "+updateState);
...
/*function selected_district($val){
	var cityValue=$val;
	alert("The Location ??? \t"+$val);
	
	 options += '<option value="' + cityValue + '">' + cityValue + '</option>';
		$('#secondlist').html(options);
	if(cityValue !=''){
		 options += '<option value="' + 'Thuraiyur' + '">' + 'Thuraiyur' + '</option>';
		$('#secondlist').html(options);
	}
